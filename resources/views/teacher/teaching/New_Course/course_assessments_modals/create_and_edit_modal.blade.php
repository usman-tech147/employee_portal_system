                ...
                <form id="course_assessment_form" data-toggle="validator">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="course_title" name="course_title" class="form-control" onchange="getCourseCode()">
                                <option value="default">Choose...</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="semester" name="semester" class="form-control">
                                <option value="default">Choose...</option>
                                <option value="semester 1"> spring </option>
                                <option value="semester 2"> fall </option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
